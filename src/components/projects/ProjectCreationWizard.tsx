    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="w-[95vw] sm:w-full md:max-w-[70%] max-h-[90vh] min-h-0 overflow-hidden flex flex-col p-0 rounded-2xl border-zinc-200">
        <DialogHeader className="p-4 sm:p-6 border-b border-zinc-100 bg-zinc-50/50">
          <DialogTitle className="text-lg sm:text-xl font-bold">Project Setup</DialogTitle>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-hidden flex flex-col md:flex-row min-h-0">
            ...
            <div className="flex gap-2">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  >
                    {currentStepIndex > index ? <Check className="w-3 h-3" /> : index + 1}
                  </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6">
              ...
              <div className="mb-6">
                <h3 className="text-base sm:text-lg font-bold text-zinc-900">{steps[currentStepIndex].label}</h3>
              </div>
              {renderStepContent()}
